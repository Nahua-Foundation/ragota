...
func New(stor storage.Storage, indexers map[indexing.IndexType]indexing.Indexer, linker *graph.Linker) *Enricher {
	return &Enricher{storage: stor, indexers: indexers, linker: linker}
}
