...
func TestRerankE2E(t *testing.T) {
	...
	baseSrv, _ := servertest.SetupServer(t)
	baseID := addRepo(t, client, baseSrv.URL, "web-rerank-base", servertest.TestdataPath(t, "web-ts"))
	...
	id := addRepo(t, client, httpSrv.URL, "web-rerank", servertest.TestdataPath(t, "web-ts"))
