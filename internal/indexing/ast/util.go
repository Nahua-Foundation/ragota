...
// extractImplementsEdges парсит doc-комментарий на предмет "// implements InterfaceName"
// и добавляет implements-edges.
func extractImplementsEdges(doc string, srcIdx, line int, edges *[]pendingEdge) {
	if doc == "" {
		return
	}
