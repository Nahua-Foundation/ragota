...
var genericTopicVerbs = map[string]string{
	"addsubscription": storage.EdgeConsumes, "addconsumer": storage.EdgeConsumes,
	"addsubscriber": storage.EdgeConsumes, "addeventhandler": storage.EdgeConsumes,
	"addmessagehandler": storage.EdgeConsumes, "addhandler": storage.EdgeConsumes,
	"subscribe": storage.EdgeConsumes, "subscribeasync": storage.EdgeConsumes,
	"consume": storage.EdgeConsumes, "consumeasync": storage.EdgeConsumes,
	"register": storage.EdgeConsumes, "registerhandler": storage.EdgeConsumes,
	"registerconsumer": storage.EdgeConsumes, "handle": storage.EdgeConsumes,

	"publish": storage.EdgeProduces, "publishasync": storage.EdgeProduces,
	"send": storage.EdgeProduces, "sendasync": storage.EdgeProduces,
	"dispatch": storage.EdgeProduces, "dispatchasync": storage.EdgeProduces,
	"enqueue": storage.EdgeProduces,
}
