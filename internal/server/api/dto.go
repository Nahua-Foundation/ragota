...
func toSearchHit(h *index.Hit, snippet string) *SearchHit {
	if h == nil {
		return nil
	}
	return &SearchHit{
...
func toSearchHits(in []*index.Hit, snippet string) []*SearchHit {
...
func toRepo(r *domain.Repo) *Repo {
	if r == nil {
		return nil
	}
	return &Repo{
...
func toRepos(in []*domain.Repo) []*Repo {
	if in == nil {
		return nil
	}
...
func toIndexAck(a *app.IndexAck) *IndexAck {
	if a == nil {
		return nil
	}
	return &IndexAck{
...
func toCoverageKind(k app.CoverageKind) CoverageKind {
	return CoverageKind{Kind: k.Kind, Candidates: k.Candidates, Edges: k.Edges, Ratio: k.Ratio}
}

func toCoverage(r *app.CoverageReport) *Coverage {
	if r == nil {
		return nil
	}
	out := &Coverage{
...
func toUnit(u *domain.ASTUnit) *Unit {
	if u == nil {
		return nil
	}
	return &Unit{
		...
		Summary: store.DecodeUnitMeta(u.Meta).Summary,
	}
}

func toGraphEdge(e *domain.Edge) *GraphEdge {
	if e == nil {
		return nil
	}
	m := store.DecodeEdgeMeta(e.Meta)
	return &GraphEdge{
...
func toJob(j *domain.IndexJob) *Job {
	if j == nil {
		return nil
	}
	return &Job{
...
func toJobs(in []*domain.IndexJob) []*Job {
...
func toContext(res *app.ContextResult, snippet string) *ContextResponse {
	if res == nil {
		return nil
	}
	out := &ContextResponse{
