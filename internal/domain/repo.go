...
type Repo struct {
	...
	// It lets a client tell "in flight" from "lost" while status is index.
	...
	// re-registered — and it changes only through store.SetActiveRepos.
	Active bool `json:"active"`
}

// Status represents repository progress.
type Status string
