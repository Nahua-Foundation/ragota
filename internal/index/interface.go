...
type IndexResult struct {
	...
	// Coverage counts, per contract kind (domain.ContractKindHTTP and
...
// (see internal/app/coverage.go).
func (r *IndexResult) ContractCoverage() map[string]domain.CoverageCounts {
	return r.Coverage
}
...
type SearchQuery struct {
	...
	// retrieval (see app.promoteCallers).
	Intent string
}
