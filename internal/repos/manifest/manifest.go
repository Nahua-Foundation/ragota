// Package manifest reads .ragota.yaml, the optional file with which a
// repository describes itself to the indexer.
//
//	services:
//	  - name: orders
...
// Names are the accepted file names, in the order they are tried.
var Names = []string{".ragota.yaml", ".ragota.yml"}

// Service is a service the repository declares explicitly, overriding whatever
...
// Load reads the repository's manifest. A repository without one is not an
